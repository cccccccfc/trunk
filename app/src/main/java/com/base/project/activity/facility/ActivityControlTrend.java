 ...
 * 空气净化器详情页
 */
public class ActivityControlTrend extends AppCompatActivity implements View.OnClickListener{
    ...
    HorizontalBarChart tempHorizonBarchart;
    @BindView(R.id.line)
    ImageView line;
    @BindView(R.id.text_trend_dianliang)
    TextView textTrendDianliang;
    @BindView(R.id.img_trend_dianliang)
    ImageView imgTrendDianliang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_control_trend);
